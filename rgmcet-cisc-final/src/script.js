	...
	/***************************************************
		...
		****************************************************/
		var typed=new Typed(".text",{
			strings:["C I S C Clubs","CSE-Department","RGMCET","EXCEL","PULSE","H 2 H","INSCRIBE","Z E N","C R E 8"],
			typeSpeed:80,
			backSpeed:80,
			backDelay:800,
			loop:true,
	...
	function cardDisplay(){
		...
		cards.forEach(card => {
			...
			<div class="see-more" id="seemore" >
					...
					<div class="social-media-part-mobile">
						<a href=${facebook}><img src="./src/images/facebook.png" style="width:50px" class="facebook" alt="facebook"></a>
						<a href=${twitt}><img src="./src/images/email.png" style="width:50px" class="twit" alt="twitter" ></a>
						<a href=${insta}><img src="./src/images/instagram (1).png"  style="width:50px" class="instagram" alt="instagram"></a>
						<a href=${youtube}><img src="./src/images/youtube (1).png"  style="width:50px" class="youtube" alt="youtube"></a>
					</div>
